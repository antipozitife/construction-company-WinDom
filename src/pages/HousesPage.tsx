...
import ImageSlider1 from '../../img/2floor(5).jpg'
import ImageSlider2 from '../../img/2floor.jpg'
import ImageSlider3 from '../../img/2floor(2).jpg'
import ImageSlider4 from '../../img/2floor(3).jpg'
import ImageSlider5 from '../../img/1floor.jpg'
import ImageSlider6 from '../../img/2floor(4).jpg'
import ImageSlider7 from '../../img/1floor(1).jpg'
import ImageSlider8 from '../../img/1floor(2).jpg'
import ImageSlider9 from '../../img/1floor(3).jpg'
import ImageSlider10 from '../../img/1floor(4).svg'
import ImageSlider11 from '../../img/1floor(5).jpg'
import ImageSlider12 from '../../img/townhouse.jpg'
import ImageSlider13 from '../../img/townhouse(1).jpg'
import ImageSlider14 from '../../img/townhouse(2).jpg'
import ImageSlider15 from '../../img/townhouse(3).jpg'
import ImageSlider16 from '../../img/townhouse(4).jpg'
import ImageSlider17 from '../../img/townhouse(5).jpg'
