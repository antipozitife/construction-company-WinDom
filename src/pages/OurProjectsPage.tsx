...
import isum from '../../img/Izumrudniy.svg';
import iq from '../../img/townhouse(2).svg';
import usadi from '../../img/1floor.svg';
        ...
        <div className="projects">
            ...
            <div className="ad-container">
              ...
              <div className="ad-info">
                <div className="ad-text-left">
                  <h1><span className="orange">ИЗУМРУДНЫЙ</span> VILLAGE</h1>
          ...
          <Link to="/projects/iqclub">
            <div className="ad-container">
              ...
              <div className="ad-info">
                <div className="ad-text-left">
                  <h1><span className="orange">IQ</span> CLUB</h1>
                  <p className="location">
                    <img src ={img1} />
          ...
          <Link to="/projects/usadi">
            <div className="ad-container">
              ...
              <div className="ad-info">
                <div className="ad-text-left">
                  <h1><span className="orange">УСАДЫ</span> VILLAGE</h1>
                  <p className="location">
                    <img src ={img1} />
