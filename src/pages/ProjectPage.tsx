      ...
      <div className='aboutProject'>
        ...
        <div className='aboutProjectContent'>
          ...
          <div className='text-container'>
            ...
            <ul>
              <li><img src={project.IMGaboutList1} /><span>{project.aboutList1}</span></li>
              <li><img src={project.IMGaboutList2} /><span>{project.aboutList2}</span></li>
              <li><img src={project.IMGaboutList3} /><span>{project.aboutList3}</span></li>
              <li><img src={project.IMGaboutList4} /><span>{project.aboutList4}</span></li>
            </ul>
          </div>
        </div>
      </div>
