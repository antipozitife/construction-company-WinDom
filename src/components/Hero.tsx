...
const Hero = () => {
  ...
  return (
    <div className="hero">
      ...
      <h1>
        <span className="hero-kicker">СТРОИТЕЛЬНАЯ КОМПАНИЯ</span>
      ...
      <div className="hero-buttons">
        <ScrollLink to="OurProjects" smooth="linear" duration={500}>
          <button type="button">Подробнее о проектах</button>
        </ScrollLink>
        <button type="button" onClick={handleOpenModal2}>Задать вопрос</button>
      </div>
